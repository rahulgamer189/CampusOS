...
public final class DatabaseModule_ProvideAchievementDaoFactory implements Factory<AchievementDao> {
  ...
  public DatabaseModule_ProvideAchievementDaoFactory(Provider<CampusOSDatabase> dbProvider) {
  ...
  public static AchievementDao provideAchievementDao(CampusOSDatabase db) {
